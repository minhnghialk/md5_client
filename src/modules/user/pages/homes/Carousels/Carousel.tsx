    ...
    <div>
      ...
      >
        ...
        <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
          ...
          <div className="duration-700 ease-in-out" data-carousel-item="">
            <img
              src="https://www.absolut.com/wp-content/uploads/absolut-paper-kv_16x7.jpg?imwidth=1200"
              className="absolute block w-full h-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
              alt="..."
            />
          </div>
          ...
          <div className="duration-700 ease-in-out" data-carousel-item="">
            <img
              src="https://www.absolut.com/en/products/absolut-grapefruit/"
              className="absolute block w-full h-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
              alt="..."
            />
          </div>
          ...
          {/* <div className="duration-700 ease-in-out" data-carousel-item="">
            <img
              src="hhttps://www.absolut.com/en/products/absolut-grapefruit/"
              className="absolute block w-full h-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
              alt="..."
            />
          </div> */}
          ...
          {/* <div className="duration-700 ease-in-out" data-carousel-item="">
            <img
              src="https://www.absolut.com/en-us/products/absolut-watermelon/"
              className="absolute block w-full h-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
              alt="..."
            />
          </div> */}
